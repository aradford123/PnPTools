...
def login():
    ...
    try:
        ...
        if exc_info.response.status_code == 401:
            print('Authentication to APIC-EM Failed. Please provide valid username/password.')
        ...
        print('Connection aborted. Please check if the APIC-EM host {} is available.'.format(host))
        exit(1)
